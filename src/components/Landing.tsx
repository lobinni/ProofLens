...
const CAPABILITIES = [
  {
    ...
    body: "Recent sends, receives, approvals, swaps, bridges, failures — and the rhythm between them.",
  },
  {
    icon: Banknote,
  ...
  {
    icon: Boxes,
    title: "Apps & contract use",
    body: "See which on-chain apps the wallet returns to, how often it interacts, and whether its activity is concentrated in only a few places.",
  },
  {
    icon: Network,
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-5 pt-36 pb-20 md:px-8 md:pt-44 md:pb-28">
          ...
          >
            ...
            Polygon and Gnosis, then asks independent validators what the visible activity says.
      ...
      <section className="border-y border-line/70 bg-ink-2/40">
        <div className="mx-auto max-w-7xl px-5 py-24 md:px-8 md:py-32">
          <div className="grid gap-12 md:grid-cols-[0.9fr_1.1fr] md:items-end">
            <Reveal>
              <p className="mono-label text-amber">02 — How it works</p>
              <h2 className="mt-4 max-w-xl text-4xl font-semibold tracking-tight md:text-5xl">
                Public activity in.
                <span className="font-serif-i font-normal text-mute"> Independent verdict out.</span>
              </h2>
            </Reveal>
            <Reveal delay={0.1}>
              <div className="space-y-5 text-base leading-relaxed text-mute">
                <p>
                  ProofLens follows the wallet across the selected networks, brings its activity
                  into one readable report, and keeps missing or incomplete records visible.
                </p>
                <p>
                  The report is then sealed and presented to independent GenLayer validators.
                  They check the public records for themselves before agreeing on what the visible
                  behavior says. The final verdict stays linked to the evidence behind it.
                </p>
              </div>
            </Reveal>
          </div>
