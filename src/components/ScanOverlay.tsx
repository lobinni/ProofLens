...
const STAGES: { id: ScanStage; label: string; hint: string }[] = [
  { id: "resolving", label: "Resolve", hint: "lock the subject" },
  { id: "collecting", label: "Collect", hint: "read six explorers" },
  { id: "analyzing", label: "Analyze", hint: "deterministic analytics" },
  { id: "committing", label: "Commit", hint: "canonical evidence · sha-256" },
  { id: "attesting", label: "Attest", hint: "relayer → studionet" },
  { id: "consensus", label: "Consensus", hint: "validators replay proofs" },
];
