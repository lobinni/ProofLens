...
def _normalize_result(raw):
    ...
    return {
        ...
        "policy_version": "prooflens-risk-v3",
    }
...
class ProofLensIntelligence(gl.Contract):
    ...
    def __init__(self):
        ...
        self.policy_version = "prooflens-risk-v3"
...
""" + json.dumps(model_input, sort_keys=True)
            ...
            # ---- Hard enforcement: override to inconclusive on weak coverage ----
            if coverage_weak and result["classification"] != "inconclusive":
